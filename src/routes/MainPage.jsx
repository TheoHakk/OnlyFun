    ...
    return (
        <div
            ...
            <div className="flex flex-col items-center justify-center">
                <h1 className="text-5xl font-bold text-center text-gray-800 dark:text-white md:text-6xl">Welcome to
                    OnlyFun</h1>
                <p className="mt-2 text-center text-gray-600 dark:text-gray-400 md:text-lg">The best place to find the
                    best games</p>
            </div>
        </div>
    );
